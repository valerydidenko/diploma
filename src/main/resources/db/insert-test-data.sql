INSERT IGNORE INTO users (user_id, login, password, ukr_name, ukr_surname, eng_name, eng_surname, role) VALUES
(1, 'admin', 'admin', 'Валерій', 'Діденко', 'Valery', 'Didenko', 'ADMIN'),
(2, 'user', 'user', 'Микола', 'Іванов', 'Nikolay', 'Ivanov', 'USER');

INSERT IGNORE INTO students (student_id, usede_id, ukr_surname, ukr_name, ukr_father_name, ukr_country, eng_surname, eng_name, eng_father_name, eng_country, degree, date_of_birth, get_into_year, graduate_year) VALUES
(1, 7654321, 'Целковський', 'Олександр', 'Анатолійович', 'Україна', 'Tselkovsky', 'Oleksander', 'Anatoliyovich', 'Ukraine', 'Bachelor', '1996-04-18', 2014, 2017),
(2, 6132863, 'Куриленко', 'Аліна', 'Олегівна', 'Україна', 'Kurilenko', 'Alina', 'Olegivna', 'Ukraine', 'Bachelor', '1999-02-25', 2016, 2017),
(3, 1234567, 'Ворошкевич', 'Ніка', 'Кирилівна', 'Україна', 'Voroshkevych', 'Nika', 'Kirilivna', 'Ukraine', 'Bachelor', '1996-07-27', 2014, 2017);

INSERT IGNORE INTO specialties (specialty_id, ukr_name, eng_name, ukr_specialization, eng_specialization, year) VALUES
(1, '123 - Комп\'ютерна інженерія', '123 - Computer engineering', 'Спеціалізовані комп\'ютерні системи', 'Specialized computer systems', 2015),
(2, '123 - Комп\'ютерна інженерія', '123 - Computer engineering', 'Спеціалізовані комп\'ютерні системи', 'Specialized computer systems', 2016),
(3, '123 - Комп\'ютерна інженерія', '123 - Computer engineering', 'Спеціалізовані комп\'ютерні системи', 'Specialized computer systems', 2017),
(4, '123 - Комп\'ютерна інженерія', '123 - Computer engineering', 'Комп\'ютерні системи та мережі', 'Computer systems and networks', 2015),
(5, '123 - Комп\'ютерна інженерія', '123 - Computer engineering', 'Комп\'ютерні системи та мережі', 'Computer systems and networks', 2016),
(6, '123 - Комп\'ютерна інженерія', '123 - Computer engineering', 'Комп\'ютерні системи та мережі', 'Computer systems and networks', 2017);
...
INSERT IGNORE INTO exclusions (exclusion_id, ukr_reason, eng_reason) VALUES
  (1, 'У зв\'язку з переведенням до Національного технічного університету України \"Київський політехнічний інститут імені Ігоря Сікорського\"',
...
INSERT IGNORE INTO signs (sign_id, ukr_surname, ukr_name, ukr_father_name, eng_surname, eng_name, eng_father_name, position_id) VALUES
...
INSERT IGNORE INTO `references` (reference_id, number, sign_date, `order`, order_date, student_id, specialty_id, exclusion_id, user_id) VALUES
